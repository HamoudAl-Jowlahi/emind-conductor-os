...
Requires **Node 18+** (on Node 24+, `better-sqlite3` must be `^13` — earlier majors have no prebuilt binary).
...
- **Next.js 16** (App Router, server components, Turbopack) plus **TypeScript**
